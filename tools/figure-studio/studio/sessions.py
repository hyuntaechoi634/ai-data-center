...
TEMPLATE_REVISION_PATHS = (
    ...
    Path("figures/supplementary-01"),
    Path("figures/supplementary-02"),
    Path("figures/supplementary-03"),
    Path("figures/supplementary-04"),
    Path("figures/supplementary-05"),
    Path("figures/supplementary-06"),
