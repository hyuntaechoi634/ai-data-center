#!/usr/bin/env python3
"""Figure Studio entrypoint for the authors' Figure 2."""
...
def main() -> None:
    ...
    if not LEGACY_OUTPUT.is_file():
        raise RuntimeError("Figure 2 did not create its JPG")
    output_dir = Path(os.environ["FIG_OUTPUT_DIR"])
    output_dir.mkdir(parents=True, exist_ok=True)
    target = output_dir / f"{os.environ.get('FIG_OUTPUT_STEM', 'figure-02')}.jpg"
