#!/usr/bin/env python3
"""Figure Studio entrypoint for Supplementary Figure 3."""
...
def main() -> None:
    ...
    if not CANONICAL_OUTPUT.is_file():
        raise RuntimeError("Supplementary Figure 3 did not create its JPG")
    output_dir = Path(os.environ["FIG_OUTPUT_DIR"])
    output_dir.mkdir(parents=True, exist_ok=True)
    stem = os.environ.get("FIG_OUTPUT_STEM", "supplementary-03")
